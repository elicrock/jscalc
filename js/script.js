...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function offAllRadioReset() {
    adapt.checked = false;
    mobileTemplates.disabled = true;
    mobileTemplates.checked = false;
    desktopTemplates.checked = false;
    editable.checked = false;
    metrikaYandex.checked = false;
    analyticsGoogle.checked = false;
    sendOrder.checked = false;
    wantFaster.checked = false;
  }
